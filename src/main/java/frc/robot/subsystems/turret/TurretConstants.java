...
public class TurretConstants {
    ...
    public static final double shooterDistanceCoefficient = 0.095; // -- determining power relative to distance from target. directly proportional. -- 0.0832 is calculated value for target on ground 
    public static final double shooterDistanceIntercept = 0.1; // -- determining starting amount that is adding to the power -- 0.0452 is calculated value for target on ground
