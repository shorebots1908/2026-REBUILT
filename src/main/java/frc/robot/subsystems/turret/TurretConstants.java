...
public class TurretConstants {
    ...
    public static final double shooterDistanceCoefficient = 8.4; // -- determining power relative to distance from target -- 9.125 is calculated value for target on ground 
